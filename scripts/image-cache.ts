...
export class AvatarCache {
  ...
  protected async processImage(body: ArrayBuffer, outputFileSlug: string) {
    const { width, outputDirectory } = this // get properties from this class
