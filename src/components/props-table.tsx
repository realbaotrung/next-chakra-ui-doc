...
import InlineCode from './mdx-components/inline-code'
...
// TODO: Remove this when we update props-doc
      ...
      {propList.map((prop) => (
        <chakra.div
          ...
          css={{
            width: '100%',
            fontSize: '0.95rem',
            // https://www.w3schools.com/cssref/tryit.php?filename=trycss_border-collapse
