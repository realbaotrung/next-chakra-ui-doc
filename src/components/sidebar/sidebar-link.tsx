import { Flex, PropsOf, chakra, useColorModeValue } from '@chakra-ui/react'
import { useRouter } from 'next/router'
import { forwardRef, Ref, useEffect, useRef, ReactElement } from 'react'
...
const checkHref = (href: string, slug: string | string[]) => {
